    ...
    <div class="clearfix">
        ...
        <div class="row margin-top-70 padding-bottom-66">
            <div class="column column-1-2">
                <img src='images/samples/570x380/fresh-retail-gizzards-md.jpg' alt='Fresh Retail Gizzards'>
            </div>
            <div class="column column-1-2">
                <h3 class="box-header">DESCRIPTION</h3>
                <p class="description t1">Fresh Retail Chicken Gizzards, 500g Wrapped in Tray.</p>
