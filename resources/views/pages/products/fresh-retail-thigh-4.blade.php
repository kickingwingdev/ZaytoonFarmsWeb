...
@section('content')
	...
	<div class="row margin-top-70 padding-bottom-66">
	    <div class="column column-1-2">
	            <img src='images/samples/570x380/fresh-retail-thigh-4-md.jpg' alt='Fresh Retail Thigh 4'>
	    </div>
		<div class="column column-1-2">
		    <h3 class="box-header">DESCRIPTION</h3>
		    <p class="description t1">Fresh Retail Chicken Thighs wrapped 4 pieces in a tray.</p>
