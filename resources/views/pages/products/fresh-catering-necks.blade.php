    ...
    <div class="clearfix">
        ...
        <div class="row margin-top-70 padding-bottom-66">
            <div class="column column-1-2">
                <img src='images/samples/570x380/fresh-catering-necks-md.jpg' alt='Fresh Catering Necks'>
            </div>
            <div class="column column-1-2">
                <h3 class="box-header">DESCRIPTION</h3>
                <p class="description t1">Fresh Catering Chicken Necks, Packed per kg in Clear Bag.</p>
