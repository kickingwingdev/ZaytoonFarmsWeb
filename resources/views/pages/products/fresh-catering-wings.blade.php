    ...
    <div class="clearfix">
        ...
        <div class="row margin-top-70 padding-bottom-66">
            <div class="column column-1-2">
                <img src='images/samples/570x380/fresh-catering-wings-md.jpg' alt='Fresh Catering Wings'>
            </div>
            <div class="column column-1-2">
                <h3 class="box-header">DESCRIPTION</h3>
                <p class="description t1">Bulk Catering Chicken Wings, Packed per kg in Clear Bag.</p>
