...
@section('content')
	...
	<div class="row padding-bottom-50">
	    <ul class="tabs-navigation small gray isotope-filters margin-top-70">
	        <li><a class="selected" href="#filter-*" title="Products">All Products</a></li>
	        <li><a href="#filter-retail" title="Retail">Retail A-Grade</a></li>
	        <li><a href="#filter-value" title="Value">Added Value</a></li>
	        <li><a href="#filter-catering" title="Catering">Catering A-Grade</a></li>
	        <li><a href="#filter-giblets" title="Giblets">Giblets</a></li>
	        <li><a href="#filter-other" title="Other">Other</a></li>
	    </ul>
